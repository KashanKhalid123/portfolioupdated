  ...
  return (
    <div className="wrapper">
      ...
      <div className="text-lg tracking-wide flex flex-col gap-6">
        <p>
          I am a web developer with 2+ years of experience in Typescript and Python. I have a
          strong foundation in front-end & back-end development and am skilled
          in creating user-friendly and responsive web applications using Typescript
          and its ecosystem. I have experience working on a variety of projects,
          including building and maintaining single page applications, and implementing responsive design
          principles. I am also proficient in using tools such as npm,
